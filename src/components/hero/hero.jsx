...
function Hero(){
    return(
        <div className={style.hero}>
            ...
            <div className={style.cards}>
                <Cardsell title='Breed Dry Dog Food' imgSrc={dogFood} alt=""  price='$100' numberstar='35'></Cardsell>
                <Cardsell title='CANON EOS DSLR Camera' imgSrc={canonCamera} alt=""  price='$960' numberstar='95'></Cardsell>
                <Cardsell title='ASUS FHD Gaming Laptop' imgSrc={laptop} alt=""  price='$700' numberstar='325'></Cardsell>
                <Cardsell title='Curology Product Set' imgSrc={curology} alt=""  price='$500'  numberstar='145'></Cardsell>
            </div>
            <div className={style.cards}>
            <Cardsell title='Kids Electric Car' imgSrc={eletricCar} alt=""  price='960' numberstar='65'></Cardsell>
                <Cardsell title='Jr. Zoom Soccer Cleats' imgSrc={soccerCleats} alt=""  price='$1160' numberstar='35'></Cardsell>
                <Cardsell title='GP11 Shooter USB Gamepad' imgSrc={usbGamepad} alt=""  price='$660' numberstar='55'></Cardsell>
                <Cardsell title='Quilted Satid Jacket' imgSrc={jacket} alt=""  price='$660'  numberstar='55'></Cardsell>
            </div>
            <Botton desc='View All Products'></Botton>
